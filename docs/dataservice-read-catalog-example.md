...
if (catalogResponse.IsSuccessful()) {
    ...
    EDGE_SDK_LOG_ERROR("read-example", "Request catalog metadata - Failure");
}
```
...
if (partitionsResponse.IsSuccessful()) {
    ...
    EDGE_SDK_LOG_ERROR("read-example", "Request partition metadata - Failure");
}
```
...
if (dataResponse.IsSuccessful()) {
    ...
    EDGE_SDK_LOG_ERROR("read-example", "Request partition data - Failure");
}
```
