...
class DATASERVICE_READ_API CompatibleVersionsRequest final {
 public:
  using Dependencies = std::vector<CompatibleVersionDependency>;
  ...
  /**
   * @brief Sets the dependencies to check the catalog versions for compatibility.
   *
   ...
   * response. The default limit is 100.
   *
   * @return A reference to the updated `CompatibleVersionsRequest` instance.
   */
