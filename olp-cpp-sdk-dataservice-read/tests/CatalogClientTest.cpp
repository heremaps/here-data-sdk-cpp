...
#ifdef _WIN32
const std::string kClientTestDir("\\catalog_client_test");
const std::string kClientTestCacheDir("\\catalog_client_test\\cache");
#else
const std::string kClientTestDir("/catalog_client_test");
const std::string kClientTestCacheDir("/catalog_client_test/cache");
#endif
...
class CatalogClientCacheTest : public CatalogClientTest {
  void SetUp() {
    CatalogClientTest::SetUp();
