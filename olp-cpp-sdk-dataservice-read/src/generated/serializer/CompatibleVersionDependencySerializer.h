...
inline void to_json(const dataservice::read::CompatibleVersionDependency& x,
...
template <>
inline void to_json<dataservice::read::CompatibleVersionDependency>(
    const std::vector<dataservice::read::CompatibleVersionDependency>& x,
