...
namespace {
void censor_credentials_part(std::string& url, std::size_t arguments_start,
...
std::string CensorCredentialsInUrl(std::string url) {
  ...
  censor_credentials_part(url, arguments_start_pos, app_id_name);
  censor_credentials_part(url, arguments_start_pos, app_code_name);
