...
namespace olp {
namespace geo {
// TODO: Remove class-of-statics antipattern/javaism
class CORE_API TileKeyUtils {
 public:
  ...
  /**
   Merges the given parent tile key and the sub tile key to an absolute tile
   key.
...
/**
 * Calculate tiling-space box of a tile
 * @param[in] tiling_scheme Tiling scheme
