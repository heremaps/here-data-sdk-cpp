...
#define URL_LOOKUP_INGEST \
  R"(https://api-lookup.data.api.platform.here.com/lookup/v1/resources/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/apis/ingest/v1)"
...
#define URL_LOOKUP_PUBLISH_V2 \
  R"(https://api-lookup.data.api.platform.here.com/lookup/v1/resources/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/apis/publish/v2)"
...
#define URL_LOOKUP_BLOB \
  R"(https://api-lookup.data.api.platform.here.com/lookup/v1/resources/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/apis/blob/v1)"
...
#define URL_LOOKUP_VOLATILE_BLOB \
  R"(https://api-lookup.data.api.platform.here.com/lookup/v1/resources/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/apis/volatile-blob/v1)"
...
#define URL_LOOKUP_INDEX \
  R"(https://api-lookup.data.api.platform.here.com/lookup/v1/resources/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/apis/index/v1)"
#define HTTP_RESPONSE_LOOKUP_INDEX \
  R"jsonString([{"api":"index","version":"v1","baseURL":"https://index.data.api.platform.here.com/index/v1/catalogs/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog","parameters":{}}])jsonString"

#define URL_LOOKUP_METADATA \
  R"(https://api-lookup.data.api.platform.here.com/lookup/v1/resources/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/apis/metadata/v1)"
...
#define URL_LOOKUP_QUERY \
  R"(https://api-lookup.data.api.platform.here.com/lookup/v1/resources/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/apis/query/v1)"
...
#define URL_INSERT_INDEX \
  R"(https://index.data.api.platform.here.com/index/v1/catalogs/hrn:here:data::olp-here-test:olp-cpp-sdk-ingestion-test-catalog/layers/olp-cpp-sdk-ingestion-test-index-layer)"
